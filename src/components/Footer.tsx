      ...
      <div className="container-page py-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:justify-between">
          <div className="max-w-md">
            <p className="font-bold text-navy">Right to Repair</p>
          ...
          <nav aria-label="Footer" className="grid grid-cols-2 gap-x-10 gap-y-2 text-sm">
            <Link className="text-govblue hover:underline" to="/report">
              Report a repair
            </Link>
            <Link className="text-govblue hover:underline" to="/track">
              Track a repair
            </Link>
            <Link className="text-govblue hover:underline" to="/performance">
              Performance data
            </Link>
            <Link className="text-govblue hover:underline" to="/officer">
              Officer sign-in
            </Link>
          </nav>
        </div>
